...
export function Layout() {
  ...
  return (
    <>
      ...
      <div className="text-bg bg-white dark:text-white dark:bg-bg font-sans w-screen h-screen overflow-none">
        <div className="w-full h-full relative z-10 flex flex-col overflow-none">
